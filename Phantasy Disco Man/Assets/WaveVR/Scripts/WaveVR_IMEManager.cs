...
public class WaveVR_IMEManager
{
    ...
    private const string IME_MANAGER_CLASSNAME = "com.htc.vr.ime.bridge.IMEManager";
    ...
    {
        internal RequestCompleteHandler() : base(new AndroidJavaClass("com.htc.vr.ime.bridge.IMECallback"))
        {
        }
